    ...
    <div className="card panel-glow">
      ...
      <div className="mt-4 flex items-center gap-4">
        <div className="relative">
          ...
          <span className="absolute inset-0 grid place-items-center font-mono text-sm font-semibold tabular">
            {level.level}
          </span>
        </div>
        <div>
          <h3 className="text-2xl font-bold">{level.title}</h3>
          <p className="text-sm text-muted tabular font-mono">{Math.round(level.xp)} XP</p>
          {level.next && (
